...
export const PlatformShell = () => {
  ...
  return <div className="page-grid platform-grid"><aside className="app-sidebar"><div className="brand"><span className="brand-mark">▦</span><span><span className="brand-name">EDU OPS</span><span className="brand-version">PLATFORM</span></span></div>
    <div className="tenant-chip"><span>Phạm vi tài khoản</span><strong>Nền tảng · toàn hệ thống</strong></div><nav className="sidebar-nav"><p className="nav-section-label">Quản trị</p><NavLink className="nav-link" to="/platform/app/tenants"><Building2 size={18}/> Trung tâm</NavLink><NavLink className="nav-link" to="/platform/app/quotas"><DatabaseZap size={18}/> Quota file</NavLink></nav>
