...
const apiErrorMessages: Partial<Record<ApiErrorCode, string>> = {
  ...
  ACCOUNT_LOCKED: "Tài khoản đang bị khóa. Vui lòng liên hệ quản trị viên trung tâm để được hỗ trợ.",
  ...
  TENANT_REQUIRED: "Không xác định được trung tâm đang sử dụng. Vui lòng mở lại từ trang đăng nhập.",
  ...
  SCHEDULE_PREVIEW_STALE: "Lịch đã thay đổi từ lần kiểm tra gần nhất. Vui lòng kiểm tra lại trước khi lưu.",
  ...
  OPTIMISTIC_LOCK_CONFLICT: "Nội dung vừa được người khác cập nhật. Vui lòng tải lại và thực hiện lại thay đổi.",
  ...
  CHECK_IN_TOO_EARLY: "Chưa đến thời gian xác nhận buổi dạy. Bạn có thể xác nhận từ 30 phút trước giờ học.",
  ...
  SELF_MANAGEMENT_FORBIDDEN: "Bạn không thể tự thay đổi trạng thái hoặc quyền của tài khoản đang dùng.",
  ...
  ENROLLMENT_VERSION_CONFLICT: "Thông tin ghi danh vừa được cập nhật. Vui lòng tải lại trước khi lưu.",
  ACTIVE_ENROLLMENT_EXISTS: "Học sinh này đang tham gia lớp.",
  ENROLLMENT_NOT_ACTIVE: "Lượt ghi danh này không còn hiệu lực.",
  ENROLLMENT_BATCH_INVALID: "Một hoặc nhiều học sinh chưa thể được thêm vào lớp. Vui lòng kiểm tra lại danh sách.",
  WARNINGS_NOT_ACKNOWLEDGED: "Vui lòng xem và xác nhận các cảnh báo trước khi tiếp tục.",
  OVERPAYMENT_CONFIRMATION_REQUIRED: "Số tiền trả đang lớn hơn số tiền còn lại. Vui lòng kiểm tra và xác nhận.",
  ...
  TENANT_QUOTA_EXCEEDED: "Trung tâm đã dùng hết hạn mức dung lượng. Vui lòng xóa bớt tệp hoặc liên hệ quản trị viên.",
  ...
  GMAIL_OAUTH_STATE_USED: "Yêu cầu kết nối Gmail này đã được sử dụng. Vui lòng bắt đầu lại nếu cần.",
  GMAIL_SCOPE_MISSING: "Gmail chưa cấp đủ quyền gửi thư. Vui lòng kết nối lại và chấp nhận quyền được yêu cầu.",
  GMAIL_EMAIL_UNVERIFIED: "Địa chỉ Gmail chưa được Google xác minh. Vui lòng chọn tài khoản khác.",
  GMAIL_CONNECTION_REQUIRED: "Vui lòng kết nối Gmail trước khi gửi thư thử.",
  GMAIL_REAUTH_REQUIRED: "Kết nối Gmail đã hết hiệu lực. Vui lòng kết nối lại.",
