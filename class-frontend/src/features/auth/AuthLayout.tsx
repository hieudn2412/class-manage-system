...
type AuthLayoutVariant = "split" | "compact";

interface AuthLayoutProps extends PropsWithChildren {
  variant?: AuthLayoutVariant;
}

export const AuthLayout = ({ children, variant = "split" }: AuthLayoutProps) => (
  <div className={cn("auth-page", variant === "compact" && "auth-page-compact")}>
    {variant === "split" ? (
